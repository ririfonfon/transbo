...
;------ 29v 49v timmanbtR edit page fixture tool
...
;------ 21v 41v 23v 43v 25v 45v 27v 47v  
...
;------ 29 49 timmanv move view channel setup  
...
;------ 21j 41j 23j 43j 25j 45j 27j 47j  
...
;------ 30v 50v blind update effect exbtn backup  
 ...
 ;------ 22v 42v 24v 44v 26v 46v 28v 48v 
...
;------ 30j 50j freeze preview goto exec bo  
  ...
  Shared LaunchJ()
    ...
    If LedValueIpad(7)<>LedValue(7)
      ...
      If Mid(LedBin(7),2,1) ="1";B.O.
        ...
        midiOutShortMsg_(my_hMidiOut,($015899))
        midiOutShortMsg_(my_hMidiOut2,($015899))
      Else
        midiOutShortMsg_(my_hMidiOut4,($003797))
        midiOutShortMsg_(my_hMidiOut,($005899))
        midiOutShortMsg_(my_hMidiOut2,($005899))
      EndIf
    EndIf
    
  EndProcedure
  
;------ 22j 42j 44j 26j 46j 28j 48j  
 ...
 ;------ 31v 51v 33v 53v 35v 55v 37v 57v 
...
;------ 39j 59j assign copy cue if store   
  ...
  ;------------------------------------------ 11      
     If LedValueIpad(11)<>LedValue(11)
      ...
      If Mid(LedBin(11),2,1) ="1";STORE
        ...
        midiOutShortMsg_(my_hMidiOut,($013E99))
        midiOutShortMsg_(my_hMidiOut2,($013E99))
      Else
        midiOutShortMsg_(my_hMidiOut4,($005797))
        midiOutShortMsg_(my_hMidiOut,($003E99))
        midiOutShortMsg_(my_hMidiOut2,($003E99))
      EndIf
 ...
 ;------ 31j 51j 33j 53j 35j 55j 37j 57j 
...
;------ 32v 52v 34v 54v 36v 56v 38v 58v  
...
;------ 32j 52j 34j 54j 36j 56j 38j 58j  
  ...
  ;------------------------------------------ 17     
    If LedValueIpad(17)<>LedValue(17)
      ...
      If Mid(LedBin(17),7,1) ="1";F4J
        ...
        midiOutShortMsg_(my_hMidiOut,($011899))
        midiOutShortMsg_(my_hMidiOut2,($011899))
      Else
        midiOutShortMsg_(my_hMidiOut4,($000398))
        midiOutShortMsg_(my_hMidiOut,($001899))
        midiOutShortMsg_(my_hMidiOut2,($001899))
      EndIf
 
      If Mid(LedBin(17),6,1) ="1";F4V
        midiOutShortMsg_(my_hMidiOut4,($7F0498))
        midiOutShortMsg_(my_hMidiOut,($010499))
        midiOutShortMsg_(my_hMidiOut2,($010499))
        midiOutShortMsg_(my_hMidiOut,($012C99))
        midiOutShortMsg_(my_hMidiOut2,($012C99))
      Else
        midiOutShortMsg_(my_hMidiOut4,($000498))
        midiOutShortMsg_(my_hMidiOut,($000499))
        midiOutShortMsg_(my_hMidiOut2,($000499))
        midiOutShortMsg_(my_hMidiOut,($002C99))
        midiOutShortMsg_(my_hMidiOut2,($002C99))
      EndIf

      If Mid(LedBin(17),4,1) ="1";F5J
        midiOutShortMsg_(my_hMidiOut4,($7F0698))
        midiOutShortMsg_(my_hMidiOut,($011999))
        midiOutShortMsg_(my_hMidiOut2,($011999))
      Else
        midiOutShortMsg_(my_hMidiOut4,($000698))
        midiOutShortMsg_(my_hMidiOut,($001999))
        midiOutShortMsg_(my_hMidiOut2,($001999))
      EndIf
      
      If Mid(LedBin(17),3,1) ="1";F5V
        midiOutShortMsg_(my_hMidiOut4,($7F0798))
        midiOutShortMsg_(my_hMidiOut,($010599))
        midiOutShortMsg_(my_hMidiOut2,($010599))
        midiOutShortMsg_(my_hMidiOut,($012D99))
        midiOutShortMsg_(my_hMidiOut2,($012D99))
      Else
        midiOutShortMsg_(my_hMidiOut4,($000798))
         midiOutShortMsg_(my_hMidiOut,($000599))
        midiOutShortMsg_(my_hMidiOut2,($000599))
        midiOutShortMsg_(my_hMidiOut,($002D99))
        midiOutShortMsg_(my_hMidiOut2,($002D99))
      EndIf
     ...
     If LedValueIpad(18)<>LedValue(18)
      LedValueIpad(18)=LedValue(18)  
       ...
       If Mid(LedBin(18),8,1) ="1";F1J
         ...
         midiOutShortMsg_(my_hMidiOut,($011599))
         midiOutShortMsg_(my_hMidiOut2,($011599))
      Else
        midiOutShortMsg_(my_hMidiOut4,($000A98))
        midiOutShortMsg_(my_hMidiOut,($001599))
        midiOutShortMsg_(my_hMidiOut2,($001599))
      EndIf
      
      If Mid(LedBin(18),7,1) ="1";F1V
        midiOutShortMsg_(my_hMidiOut4,($7F0B98))
        midiOutShortMsg_(my_hMidiOut,($010199))
        midiOutShortMsg_(my_hMidiOut2,($010199))
        midiOutShortMsg_(my_hMidiOut,($012999))
        midiOutShortMsg_(my_hMidiOut2,($012999))
      Else
        midiOutShortMsg_(my_hMidiOut4,($000B98))
        midiOutShortMsg_(my_hMidiOut,($000199))
        midiOutShortMsg_(my_hMidiOut2,($000199))
        midiOutShortMsg_(my_hMidiOut,($002999))
        midiOutShortMsg_(my_hMidiOut2,($002999))
      EndIf

      If Mid(LedBin(18),5,1) ="1";F2J
        midiOutShortMsg_(my_hMidiOut4,($7F0D98))
        midiOutShortMsg_(my_hMidiOut,($011699))
        midiOutShortMsg_(my_hMidiOut2,($011699))
      Else
        midiOutShortMsg_(my_hMidiOut4,($000D98))
        midiOutShortMsg_(my_hMidiOut,($001699))
        midiOutShortMsg_(my_hMidiOut2,($001699))
      EndIf
      
      If Mid(LedBin(18),4,1) ="1";F2V
        midiOutShortMsg_(my_hMidiOut4,($7F0E98))
        midiOutShortMsg_(my_hMidiOut,($010299))
        midiOutShortMsg_(my_hMidiOut2,($010299))
        midiOutShortMsg_(my_hMidiOut,($012A99))
        midiOutShortMsg_(my_hMidiOut2,($012A99))
      Else
        midiOutShortMsg_(my_hMidiOut4,($000E98))
        midiOutShortMsg_(my_hMidiOut,($000299))
        midiOutShortMsg_(my_hMidiOut2,($000299))
        midiOutShortMsg_(my_hMidiOut,($002A99))
        midiOutShortMsg_(my_hMidiOut2,($002A99))
      EndIf

      If Mid(LedBin(18),2,1) ="1";F3J
        midiOutShortMsg_(my_hMidiOut4,($7F1098))
        midiOutShortMsg_(my_hMidiOut,($011799))
        midiOutShortMsg_(my_hMidiOut2,($011799))
      Else
        midiOutShortMsg_(my_hMidiOut4,($001098))
        midiOutShortMsg_(my_hMidiOut,($001799))
        midiOutShortMsg_(my_hMidiOut2,($001799))
      EndIf
      
      If Mid(LedBin(18),1,1) ="1";F3V
        midiOutShortMsg_(my_hMidiOut4,($7F1198))
        midiOutShortMsg_(my_hMidiOut,($010399))
        midiOutShortMsg_(my_hMidiOut2,($010399))
        midiOutShortMsg_(my_hMidiOut,($012B99))
        midiOutShortMsg_(my_hMidiOut2,($012B99))
      Else
        midiOutShortMsg_(my_hMidiOut4,($001198))
        midiOutShortMsg_(my_hMidiOut,($000399))
        midiOutShortMsg_(my_hMidiOut2,($000399))
        midiOutShortMsg_(my_hMidiOut,($002B99))
        midiOutShortMsg_(my_hMidiOut2,($002B99))
       EndIf
...
;------ f9 f10 go-sel   
 ...
 ;------------------------------------------ 19
      ...
      If Mid(LedBin(19),7,1) ="1";F9J
        ...
        midiOutShortMsg_(my_hMidiOut,($011D99))
        midiOutShortMsg_(my_hMidiOut2,($011D99))
      Else
        midiOutShortMsg_(my_hMidiOut4,($001398))
        midiOutShortMsg_(my_hMidiOut,($001D99))
        midiOutShortMsg_(my_hMidiOut2,($001D99))
      EndIf
 
      If Mid(LedBin(19),6,1) ="1";F9V
        midiOutShortMsg_(my_hMidiOut4,($7F1498))
        midiOutShortMsg_(my_hMidiOut,($010999))
        midiOutShortMsg_(my_hMidiOut2,($010999))
        midiOutShortMsg_(my_hMidiOut,($013199))
        midiOutShortMsg_(my_hMidiOut2,($013199))
      Else
        midiOutShortMsg_(my_hMidiOut4,($001498))
        midiOutShortMsg_(my_hMidiOut,($000999))
        midiOutShortMsg_(my_hMidiOut2,($000999))
        midiOutShortMsg_(my_hMidiOut,($003199))
        midiOutShortMsg_(my_hMidiOut2,($003199))
      EndIf

      If Mid(LedBin(19),4,1) ="1";F10J
        midiOutShortMsg_(my_hMidiOut4,($7F1698))
        midiOutShortMsg_(my_hMidiOut,($011E99))
        midiOutShortMsg_(my_hMidiOut2,($011E99))
      Else
        midiOutShortMsg_(my_hMidiOut4,($001698))
        midiOutShortMsg_(my_hMidiOut,($001E99))
        midiOutShortMsg_(my_hMidiOut2,($001E99))
      EndIf
      
      If Mid(LedBin(19),3,1) ="1";F10V
        midiOutShortMsg_(my_hMidiOut4,($7F1798))
        midiOutShortMsg_(my_hMidiOut,($010A99))
        midiOutShortMsg_(my_hMidiOut2,($010A99))
        midiOutShortMsg_(my_hMidiOut,($013299))
        midiOutShortMsg_(my_hMidiOut2,($013299))
      Else
        midiOutShortMsg_(my_hMidiOut4,($001798))
        midiOutShortMsg_(my_hMidiOut,($000A99))
        midiOutShortMsg_(my_hMidiOut2,($000A99))
        midiOutShortMsg_(my_hMidiOut,($003299))
        midiOutShortMsg_(my_hMidiOut2,($003299))
      EndIf
     ...
     If LedValueIpad(20)<>LedValue(20)
      LedValueIpad(20)=LedValue(20)  
       ...
       If Mid(LedBin(20),8,1) ="1";F6J
         ...
         midiOutShortMsg_(my_hMidiOut,($011A99))
         midiOutShortMsg_(my_hMidiOut2,($011A99))
      Else
        midiOutShortMsg_(my_hMidiOut4,($001A98))
        midiOutShortMsg_(my_hMidiOut,($001A99))
        midiOutShortMsg_(my_hMidiOut2,($001A99))
      EndIf
      
      If Mid(LedBin(20),7,1) ="1";F6V
        midiOutShortMsg_(my_hMidiOut4,($7F1B98))
        midiOutShortMsg_(my_hMidiOut,($010699))
        midiOutShortMsg_(my_hMidiOut2,($010699))
        midiOutShortMsg_(my_hMidiOut,($012E99))
        midiOutShortMsg_(my_hMidiOut2,($012E99))
      Else
        midiOutShortMsg_(my_hMidiOut4,($001B98))
        midiOutShortMsg_(my_hMidiOut,($000699))
        midiOutShortMsg_(my_hMidiOut2,($000699))
        midiOutShortMsg_(my_hMidiOut,($002E99))
        midiOutShortMsg_(my_hMidiOut2,($002E99))
      EndIf

      If Mid(LedBin(20),5,1) ="1";F7J
        midiOutShortMsg_(my_hMidiOut4,($7F1D98))
        midiOutShortMsg_(my_hMidiOut,($011B99))
        midiOutShortMsg_(my_hMidiOut2,($011B99))
      Else
        midiOutShortMsg_(my_hMidiOut4,($001D98))
        midiOutShortMsg_(my_hMidiOut,($001B99))
        midiOutShortMsg_(my_hMidiOut2,($001B99))
      EndIf
      
      If Mid(LedBin(20),4,1) ="1";F7V
        midiOutShortMsg_(my_hMidiOut4,($7F1E98))
        midiOutShortMsg_(my_hMidiOut,($010799))
        midiOutShortMsg_(my_hMidiOut2,($010799))
        midiOutShortMsg_(my_hMidiOut,($012F99))
        midiOutShortMsg_(my_hMidiOut2,($012F99))
      Else
        midiOutShortMsg_(my_hMidiOut4,($001E98))
        midiOutShortMsg_(my_hMidiOut,($000799))
        midiOutShortMsg_(my_hMidiOut2,($000799))
        midiOutShortMsg_(my_hMidiOut,($002F99))
        midiOutShortMsg_(my_hMidiOut2,($002F99))
      EndIf

      If Mid(LedBin(20),2,1) ="1";F8J
        midiOutShortMsg_(my_hMidiOut4,($7F2098))
        midiOutShortMsg_(my_hMidiOut,($011C99))
        midiOutShortMsg_(my_hMidiOut2,($011C99))
      Else
        midiOutShortMsg_(my_hMidiOut4,($002098))
        midiOutShortMsg_(my_hMidiOut,($001C99))
        midiOutShortMsg_(my_hMidiOut2,($001C99))
      EndIf
      
      If Mid(LedBin(20),1,1) ="1";F8V
        midiOutShortMsg_(my_hMidiOut4,($7F2198))
        midiOutShortMsg_(my_hMidiOut,($010899))
        midiOutShortMsg_(my_hMidiOut2,($010899))
        midiOutShortMsg_(my_hMidiOut,($013099))
        midiOutShortMsg_(my_hMidiOut2,($013099))
      Else
        midiOutShortMsg_(my_hMidiOut4,($002198))
         midiOutShortMsg_(my_hMidiOut,($000899))
        midiOutShortMsg_(my_hMidiOut2,($000899))
        midiOutShortMsg_(my_hMidiOut,($003099))
        midiOutShortMsg_(my_hMidiOut2,($003099))
       EndIf
  ...
  Shared LaunchJ()
   ...
   ;------------------------------------------ 21     
      ...
      If Mid(LedBin(21),7,1) ="1";F14J
        ...
        midiOutShortMsg_(my_hMidiOut,($012299))
        midiOutShortMsg_(my_hMidiOut2,($012299))
      Else
        midiOutShortMsg_(my_hMidiOut4,($002398))
        midiOutShortMsg_(my_hMidiOut,($002299))
        midiOutShortMsg_(my_hMidiOut2,($002299))
      EndIf
 
      If Mid(LedBin(21),6,1) ="1";F14V
        midiOutShortMsg_(my_hMidiOut4,($7F2498))
        midiOutShortMsg_(my_hMidiOut,($010E99))
        midiOutShortMsg_(my_hMidiOut2,($010E99))
        midiOutShortMsg_(my_hMidiOut,($013699))
        midiOutShortMsg_(my_hMidiOut2,($013699))
      Else
        midiOutShortMsg_(my_hMidiOut4,($002498))
        midiOutShortMsg_(my_hMidiOut,($000E99))
        midiOutShortMsg_(my_hMidiOut2,($000E99))
        midiOutShortMsg_(my_hMidiOut,($003699))
        midiOutShortMsg_(my_hMidiOut2,($003699))
      EndIf

      If Mid(LedBin(21),4,1) ="1";F15J
        midiOutShortMsg_(my_hMidiOut4,($7F2698))
        midiOutShortMsg_(my_hMidiOut,($012399))
        midiOutShortMsg_(my_hMidiOut2,($012399))
      Else
        midiOutShortMsg_(my_hMidiOut4,($002698))
        midiOutShortMsg_(my_hMidiOut,($002399))
        midiOutShortMsg_(my_hMidiOut2,($002399))
      EndIf
      
      If Mid(LedBin(21),3,1) ="1";F15V
        midiOutShortMsg_(my_hMidiOut4,($7F2798))
        midiOutShortMsg_(my_hMidiOut,($010F99))
        midiOutShortMsg_(my_hMidiOut2,($010F99))
        midiOutShortMsg_(my_hMidiOut,($013799))
        midiOutShortMsg_(my_hMidiOut2,($013799))
      Else
        midiOutShortMsg_(my_hMidiOut4,($002798))
        midiOutShortMsg_(my_hMidiOut,($000F99))
        midiOutShortMsg_(my_hMidiOut2,($000F99))
        midiOutShortMsg_(my_hMidiOut,($003799))
        midiOutShortMsg_(my_hMidiOut2,($003799))
      EndIf
   ...
   ;------------------------------------------ 22
    ...
    If LedValueIpad(22)<>LedValue(22)
      ...
      If Mid(LedBin(22),8,1) ="1";F11J
        ...
        midiOutShortMsg_(my_hMidiOut,($011F99))
        midiOutShortMsg_(my_hMidiOut2,($011F99))
      Else
        midiOutShortMsg_(my_hMidiOut4,($002A98))
        midiOutShortMsg_(my_hMidiOut,($001F99))
        midiOutShortMsg_(my_hMidiOut2,($001F99))
      EndIf
      
      If Mid(LedBin(22),7,1) ="1";F11V
        midiOutShortMsg_(my_hMidiOut4,($7F2B98))
        midiOutShortMsg_(my_hMidiOut,($010B99))
        midiOutShortMsg_(my_hMidiOut2,($010B99))
        midiOutShortMsg_(my_hMidiOut,($013399))
        midiOutShortMsg_(my_hMidiOut2,($013399))
      Else
        midiOutShortMsg_(my_hMidiOut4,($002B98))
        midiOutShortMsg_(my_hMidiOut,($000B99))
        midiOutShortMsg_(my_hMidiOut2,($000B99))
        midiOutShortMsg_(my_hMidiOut,($003399))
        midiOutShortMsg_(my_hMidiOut2,($003399))
      EndIf

      If Mid(LedBin(22),5,1) ="1";F12J
        midiOutShortMsg_(my_hMidiOut4,($7F2D98))
        midiOutShortMsg_(my_hMidiOut,($012099))
        midiOutShortMsg_(my_hMidiOut2,($012099))
      Else
        midiOutShortMsg_(my_hMidiOut4,($002D98))
        midiOutShortMsg_(my_hMidiOut,($002089))
        midiOutShortMsg_(my_hMidiOut2,($002089))
      EndIf
      
      If Mid(LedBin(22),4,1) ="1";F12V
        midiOutShortMsg_(my_hMidiOut4,($7F2E98))
        midiOutShortMsg_(my_hMidiOut,($010C99))
        midiOutShortMsg_(my_hMidiOut2,($010C99))
        midiOutShortMsg_(my_hMidiOut,($013499))
        midiOutShortMsg_(my_hMidiOut2,($013499))
      Else
        midiOutShortMsg_(my_hMidiOut4,($002E98))
        midiOutShortMsg_(my_hMidiOut,($000C99))
        midiOutShortMsg_(my_hMidiOut2,($000C99))
        midiOutShortMsg_(my_hMidiOut,($003499))
        midiOutShortMsg_(my_hMidiOut2,($003499))
      EndIf
      
      If Mid(LedBin(22),2,1) ="1";F13J
        midiOutShortMsg_(my_hMidiOut4,($7F3098))
        midiOutShortMsg_(my_hMidiOut,($012199))
        midiOutShortMsg_(my_hMidiOut2,($012199))
      Else
        midiOutShortMsg_(my_hMidiOut4,($003098))
        midiOutShortMsg_(my_hMidiOut,($002199))
        midiOutShortMsg_(my_hMidiOut2,($002199))
      EndIf
      
      If Mid(LedBin(22),1,1) ="1";F13V
        midiOutShortMsg_(my_hMidiOut4,($7F3198))
        midiOutShortMsg_(my_hMidiOut,($010D99))
        midiOutShortMsg_(my_hMidiOut2,($010D99))
        midiOutShortMsg_(my_hMidiOut,($013599))
        midiOutShortMsg_(my_hMidiOut2,($013599))
      Else
        midiOutShortMsg_(my_hMidiOut4,($003198))
        midiOutShortMsg_(my_hMidiOut,($000D99))
        midiOutShortMsg_(my_hMidiOut2,($000D99))
        midiOutShortMsg_(my_hMidiOut,($003599))
        midiOutShortMsg_(my_hMidiOut2,($003599))
      EndIf
    EndIf
     ...
     If LedValueIpad(24)<>LedValue(24)
      LedValueIpad(24)=LedValue(24)  
       ...
       If Mid(LedBin(24),8,1) ="1";F16J
         ...
         midiOutShortMsg_(my_hMidiOut,($012499))
         midiOutShortMsg_(my_hMidiOut2,($012499))
      Else
        midiOutShortMsg_(my_hMidiOut4,($003A98))
        midiOutShortMsg_(my_hMidiOut,($002499))
        midiOutShortMsg_(my_hMidiOut2,($002499))
      EndIf
      
      If Mid(LedBin(24),7,1) ="1";F16V
        midiOutShortMsg_(my_hMidiOut4,($7F3B98))
        midiOutShortMsg_(my_hMidiOut,($011099))
        midiOutShortMsg_(my_hMidiOut2,($011099))
        midiOutShortMsg_(my_hMidiOut,($013899))
        midiOutShortMsg_(my_hMidiOut2,($013899))
      Else
        midiOutShortMsg_(my_hMidiOut4,($003B98))
        midiOutShortMsg_(my_hMidiOut,($001099))
        midiOutShortMsg_(my_hMidiOut2,($001099))
        midiOutShortMsg_(my_hMidiOut,($003899))
        midiOutShortMsg_(my_hMidiOut2,($003899))
      EndIf
...
;------ timmanv timmanr  
 ...
 If LedValueIpad(29)<>LedValue(29)
      ...
      If Mid(LedBin(29),1,1) ="1";TIM MAN R
        ...
        midiOutShortMsg_(my_hMidiOut,($015E99))
        midiOutShortMsg_(my_hMidiOut2,($015E99))
      Else
        midiOutShortMsg_(my_hMidiOut4,($006998))
        midiOutShortMsg_(my_hMidiOut,($005E99))
        midiOutShortMsg_(my_hMidiOut2,($005E99))
       EndIf
