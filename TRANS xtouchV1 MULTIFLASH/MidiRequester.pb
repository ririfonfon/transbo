...
;---- ouverture de la fenetre---------------------------------------------------------------
  ...
  #Width = 1000
  If OpenWindow(0, 0, 0, #Width , 750, "MULTI MIDI for MAonPC  by Riri" , #PB_Window_SystemMenu | #PB_Window_ScreenCentered) 
...
;---------listage midi in BCF -----------------
      TextGadget(1, 5 , 5, #Column, 18, "BCF 1 Input-Device:", #PB_Text_Center | #PB_Text_Border) 
...
;-------- listage midi out BFC --------------
      TextGadget(0, 5 + #Offset , 5, #Column, 18, "BCF 1 Output-Device:", #PB_Text_Center | #PB_Text_Border) 
