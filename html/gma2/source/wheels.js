...
window.uiTypes.pages.Wheels = (function () {
    ...
    Wheels.prototype.CreatePageButtons = function() {
        ...
        var verticalControls = document.getElementsByClassName("vertical-controls")[0];
        verticalControls.innerHTML = "";
        for(var i = 0; i < this.pageCommands.length; i++)
        {
            verticalControls.appendChild(this.pageCommands[i].uiElement.m_$item[0]);
        }
    ...
    Wheels.prototype.Show = function () {
        ...
        var dimmerWheel = document.getElementsByClassName("dimmer-wheel")[0];
        var verticalControls = document.getElementsByClassName("vertical-controls")[0];
        if(dimmerWheel && verticalControls)
        {
            dimmerWheel.classList.add("hidden");
    ...
    Wheels.prototype.Close = function () {
        ...
        setTimeout(function () {
            ...
            if(dimmerWheel && verticalControls)
            {
                dimmerWheel.classList.remove("hidden");
