...
void send_rvb2()
{
    ...
    ESP32DMX.setSlot(RRR[1], round((cgred / 255) * Mast[3]));
    ESP32DMX.setSlot(GGG[1], round((cggreen / 255) * Mast[3]));
    ESP32DMX.setSlot(BBB[1], round((cgblue / 255) * Mast[3]));
    //grp comptoire centrale
    ESP32DMX.setSlot(RRR[2], round((cred / 255) * Mast[3]));
    ESP32DMX.setSlot(GGG[2], round((cgreen / 255) * Mast[3]));
    ESP32DMX.setSlot(BBB[2], round((cblue / 255) * Mast[3]));
    //grp comptoire droit
    ESP32DMX.setSlot(RRR[3], round((cdred / 255) * Mast[3]));
    ESP32DMX.setSlot(GGG[3], round((cdgreen / 255) * Mast[3]));
    ESP32DMX.setSlot(BBB[3], round((cdblue / 255) * Mast[3]));
